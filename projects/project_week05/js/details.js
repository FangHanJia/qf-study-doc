document.addEventListener("DOMContentLoaded",function(){
    ...
    // 处理商品图片
    var picObj = [{img:'../images/new_pic.png'},{img:'../images/new_pic2.png'},{img:'../images/new_pic3.png'},{img:'../images/new_pic4.png'},{img:'../images/new_pic4.png'},{img:'../images/new_pic4.png'}];
    var imgobj = {};
    // 获取后端数据
    let status = [200,304];
    ...
    xhr.onload = ()=>{
        if(status.includes(xhr.status)){
            let res_goods = JSON.parse(xhr.responseText);
            for(var i=0;i<res_goods.length;i++){
                imgobj.img = res_goods[i].img;
                picObj.push(imgobj);
            }
        }
    }
    console.log(imgobj);
    xhr.open('get','../api/data/libiao.json');
    xhr.send();
    ...
    */
    ...
    add2car.onclick = function(e){
        ...
        //     animate(this.tips,{top:0,opacity:1});
        // }
